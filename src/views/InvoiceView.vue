  ...
  <div v-if="currentInvoice" class="invoice-view container">
    ...
    <div class="header flex">
      ...
      <div class="right flex">
        ...
        <button v-if="!currentInvoice.invoiceDraft" @click="sendEmail" class="purple">Send email</button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    sendEmail(){
      ...
      emailjs.send('service_0tpxwro', 'template_evogu5k', { to: "pilaracha97@gmail.com", invoice: this.currentInvoice}, '4fbulx-2uYLzdAIiw')
      .then((result) => {
        Toast.fire({
          icon: 'success',
        ...
        Toast.fire({
          icon: 'error',
          title: 'There was an error sending your email. Please try again later.'
        })
      });
    }
  },
